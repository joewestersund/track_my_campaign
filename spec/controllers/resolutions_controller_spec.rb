...
describe ResolutionsController do
  ...
  describe "GET index" do
    it "assigns all resolutions as @resolutions" do
      ...
      assigns(:resolutions).should eq([resolution])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested resolution as @resolution" do
      ...
      assigns(:resolution).should eq(resolution)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new resolution as @resolution" do
      ...
      assigns(:resolution).should be_a_new(Resolution)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created resolution as @resolution" do
        post :create, {:resolution => valid_attributes}, valid_session
        assigns(:resolution).should be_a(Resolution)
        assigns(:resolution).should be_persisted
      end

      it "redirects to the created resolution" do
        post :create, {:resolution => valid_attributes}, valid_session
        response.should redirect_to(Resolution.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved resolution as @resolution" do
        ...
        Resolution.any_instance.stub(:save).and_return(false)
        post :create, {:resolution => { "database_instance_id" => "invalid value" }}, valid_session
        assigns(:resolution).should be_a_new(Resolution)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested resolution" do
        ...
        Resolution.any_instance.should_receive(:update).with({ "database_instance_id" => "1" })
        put :update, {:id => resolution.to_param, :resolution => { "database_instance_id" => "1" }}, valid_session
      end
      ...
      it "redirects to the resolution" do
        resolution = Resolution.create! valid_attributes
        put :update, {:id => resolution.to_param, :resolution => valid_attributes}, valid_session
        response.should redirect_to(resolution)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the resolution as @resolution" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Resolution.any_instance.stub(:save).and_return(false)
        put :update, {:id => resolution.to_param, :resolution => { "database_instance_id" => "invalid value" }}, valid_session
        assigns(:resolution).should eq(resolution)
      end
