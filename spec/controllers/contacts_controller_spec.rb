  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contact as @contact" do
        ...
        post :create, {:contact => { "database_instance_id" => "invalid value" }}, valid_session
        assigns(:contact).should be_a_new(Contact)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contact" do
        ...
        Contact.any_instance.should_receive(:update).with({ "database_instance_id" => "1" })
        put :update, {:id => contact.to_param, :contact => { "database_instance_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contact as @contact" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contact.any_instance.stub(:save).and_return(false)
        put :update, {:id => contact.to_param, :contact => { "database_instance_id" => "invalid value" }}, valid_session
        assigns(:contact).should eq(contact)
      end
