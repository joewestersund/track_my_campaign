  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved policy as @policy" do
        ...
        post :create, {:policy => { "database_instance_id" => "invalid value" }}, valid_session
        assigns(:policy).should be_a_new(Policy)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested policy" do
        ...
        Policy.any_instance.should_receive(:update).with({ "database_instance_id" => "1" })
        put :update, {:id => policy.to_param, :policy => { "database_instance_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the policy as @policy" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Policy.any_instance.stub(:save).and_return(false)
        put :update, {:id => policy.to_param, :policy => { "database_instance_id" => "invalid value" }}, valid_session
        assigns(:policy).should eq(policy)
      end
