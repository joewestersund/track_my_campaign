  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved city as @city" do
        ...
        post :create, {:city => { "database_instance_id" => "invalid value" }}, valid_session
        assigns(:city).should be_a_new(City)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested city" do
        ...
        City.any_instance.should_receive(:update).with({ "database_instance_id" => "1" })
        put :update, {:id => city.to_param, :city => { "database_instance_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the city as @city" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        City.any_instance.stub(:save).and_return(false)
        put :update, {:id => city.to_param, :city => { "database_instance_id" => "invalid value" }}, valid_session
        assigns(:city).should eq(city)
      end
