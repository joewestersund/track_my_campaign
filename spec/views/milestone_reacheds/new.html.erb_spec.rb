...
describe "milestone_reacheds/new" do
  before(:each) do
    assign(:milestone_reached, stub_model(MilestoneReached,
  ...
  it "renders new milestone_reached form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", milestone_reacheds_path, "post" do
