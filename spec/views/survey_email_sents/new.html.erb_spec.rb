...
describe "survey_email_sents/new" do
  before(:each) do
    assign(:survey_email_sent, stub_model(SurveyEmailSent,
  ...
  it "renders new survey_email_sent form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", survey_email_sents_path, "post" do
